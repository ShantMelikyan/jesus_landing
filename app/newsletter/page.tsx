  ...
  return (
    <main className="w-full h-screen grid place-items-center place-content-center bg-gradient-to-b from-[#53577a] via-[#907d93] to-[#e6b8ae] p-6 text-[#2c3047] relative ">
      <Image
        ...
        alt="angel"
        placeholder="blur"
        className=" h-screen lg:p-4 lg:max-h-[600px] w-full lg:max-w-3xl top-1/2 left-1/2 mx-auto z-0 object-top object-cover opacity-90 rounded-b-2xl lg:rounded-3xl absolute transform -translate-x-1/2 -translate-y-1/2"
      ></Image>
