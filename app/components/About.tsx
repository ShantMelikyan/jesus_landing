  ...
  return (
    <div className="h-full w-full  text-white ">
        ...
        <div className="max-w-7xl px-6 w-full pb-20">
          <div className="grid lg:grid-cols-4 grid-cols-2 place-items-center gap-4  w-full mx-auto backdrop-blur rounded-lg text-white z-20 md:p-10 px-4 py-6 border-t border-r border-l border-b border-[#4E5172]">
            ...
            <div className="flex items-center gap-4 ">
              ...
              <p className="text-lg md:text-xl max-w-[76px] sm:max-w-[100px]">
      ...
      <div className="bg-gradient-to-b  from-[#02161D] via-[#533E57] to-[#e6b8ae]">
        ...
        <div className="w-full grid place-items-center grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 ">
          {/* faith  */}
          <div className="flex flex-col  relative gap-4 order-1 p-10 ">
            <Image
              src={cross}
              alt="cross"
            ...
            <h3 className="text-2xl uppercase font-semibold">Faith</h3>
            <Image
              src={faith}
              alt="faith icon"
          ...
          {/* community */}
          <div className="flex flex-col  relative gap-4 order-6 xl:order-2 p-10 ">
            <Image
              src={cross}
              alt="cross"
              className="absolute trabsform translate-x-44 -translate-y-4"
            ...
            <h3 className="text-2xl uppercase font-semibold">Community</h3>
            <Image
              src={community}
              alt="community icon"
              className="absolute translate-x-64 -translate-y-8 w-16"
          ...
          {/* truth */}
          <div className="flex flex-col  relative gap-4 order-3 p-10">
            <Image
              src={cross}
              alt="cross"
              className="absolute trabsform translate-x-44 -translate-y-4"
            ...
            <h3 className="text-2xl uppercase font-semibold">Truth</h3>
            <Image
              src={truth}
              alt="truth icon"
              className="absolute translate-x-64 -translate-y-8 w-16"
          ...
          {/* forgiveness */}
          <div className="flex flex-col relative gap-4 order-2 xl:order-4 px-10 p-10 ">
            <Image
              src={cross}
              alt="cross"
          ...
          {/* love */}
          <div className="flex flex-col relative gap-4 order-4  p-10 lg:p-0 lg:px-10 lg:pt-6 xl:p-10">
            <Image
              src={cross}
              alt="cross"
              className="absolute trabsform -translate-x-24 -translate-y-4 "
          ...
          {/* god  */}
          <div className="flex flex-col relative gap-4 order-6 lg:order-6 p-10 lg:p-0 lg:px-10 lg:pt-[70px]  xl:pt-10">
            <Image
              src={cross}
              alt="cross"
              className="absolute trabsform -translate-x-24 -translate-y-4"
